...
{
  public static string? FormatAttributes(AttributeBonusesModel attributes)
  {
  ...
  public static bool HasSpeeds(SpeedsModel speeds) => speeds.Walk > 0 || speeds.Climb > 0 || speeds.Swim > 0 || speeds.Fly > 0 || speeds.Hover > 0 || speeds.Hover > 0;
  ...
  public static bool HasAges(AgesModel ages) => ages.Adolescent.HasValue && ages.Adult.HasValue && ages.Mature.HasValue && ages.Venerable.HasValue;
}
